...
public class EnrollEnums {
    ...
    public enum EGZAM_PRODUCT {
        BASIC_ISTQB(0, "52", "ISTQB Foundation Level", BASIC),
        BASIC_REQB(1, "55", "REQB Foundation Level", BASIC),
        EXPERT_TEST_PROCESS(2, "53","ISTQB Improving the Test Process", EXPERT),
        EXPERT_TEST_MANAGEMENT(3, "54","ISTQB Test Management", EXPERT),
        ADVANCED_TECHNICAL_TEST_ANALYST(4,"48","ISTQB Advanced Level Technical Test Analyst", ADVANCE),
        ADVANCED_TEST_MANAGER(5,"49","ISTQB Advanced Level Test Manager", ADVANCE),
        ADVANCED_TEST_ANALYST(6,"50","ISTQB Advancel Level Test Analyst", ADVANCE),
        OTHER_AGILE_TESTER_EXTENTION(7,"51","ISTQB Agile Tester Extension", OTHER);
